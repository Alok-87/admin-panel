  ...
  return (
    <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 shadow-lg rounded-xl p-4 sm:p-8 mt-8 transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        {[
          { icon: <FiUser />, label: "Student Name", value: order.studentName },
          { icon: <FiPhone />, label: "Mobile", value: order.mobileNumber },
          { icon: <FiMail className="text-red-500" />, label: "Email", value: order.email },
